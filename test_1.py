...
from funcs import sort_list_to_asc, find_equal_name, Tools, find_longest_and_shortest_course


class TestFuncs:
    def setup_method(self):
        self.course_and_mentors = Tools()
...
class TestYandexApi:
    ...
    def test_wrong_path(self):
        response = requests.put('https://cloud-api.yandex.net/v1/disk/resource',  # resources is a right path
                                params=self.params,
                                headers=self.headers)
